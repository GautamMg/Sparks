...
<head>
    ...
    @define('bankName', 'Sparks Project : Gautams Bank',true);
...
<h1 class="alert alert-success rounded-0"><?php echo bankName; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by:Gautam MG</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
